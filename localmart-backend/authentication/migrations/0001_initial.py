# Generated by Django 5.1.7 on 2026-06-25 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('VEGETABLES', 'Vegetables'), ('BAKERY', 'Bakery'), ('DAIRY', 'Dairy'), ('GROCERY', 'Grocery')], max_length=20, null=True)),
                ...
                ('free_delivery_threshold', models.DecimalField(decimal_places=2, default=0.0, max_digits=6)),
                ('is_closed_today', models.BooleanField(default=False)),
                ('stock_last_updated', models.DateTimeField(blank=True, null=True)),
